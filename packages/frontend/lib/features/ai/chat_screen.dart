...
const _kChips = [
  ...
  _ChipDef('STM32F103C8 is out of stock. What are the alternatives?',              _ChipGroup.static_),  // K-01
  _ChipDef('What is the lead time for ESP32-WROOM-32U?',                           _ChipGroup.static_),  // K-02
  _ChipDef('How can we avoid single-supplier lock-in for MCUs?',                   _ChipGroup.static_),  // K-03
